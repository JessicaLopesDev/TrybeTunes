...
describe('4 - Crie um componente de cabeçalho', () => {
  ...
  it('Será validado se o componente Header não é renderizado na página /', async () => {
    renderPath('/');
  ...
  it('Será validado se o componente Header é renderizado na página /search', async () => {
    renderPath('/search');
  ...
  it('Será validado se o componente Header é renderizado na página /album/:id', async () => {
  ...
  it('Será validado se a função getUser é chamada ao renderizar o componente', async () => {
  ...
  it('Será validado se a mensagem de Carregando... é exibida ao renderizar o componente e é removida após o retorno da API', async () => {
    renderPath('/search');
  ...
  it('Será validado se o nome da pessoa usuária está presente na tela após o retorno da API', async () => {
    renderPath('/search');
  ...
  it('Será validado se os links de navegação são exibidos na página de pesquisa', async () => {
    renderPath('/search');
