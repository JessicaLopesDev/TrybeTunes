...
describe('9 - Crie a exibição de perfil', () => {
  ...
  it('Será validado se a API getUser é usada para recuperar as informações da pessoa logada', async () => {
  ...
  it('Será validado se as informações da pessoa logada são exibidas na tela', async () => {
    renderPath('/profile');
  ...
  it('Será validado se foi criado um link para a rota de edição de perfil com o texto Editar perfil', async () => {
    renderPath('/profile');
