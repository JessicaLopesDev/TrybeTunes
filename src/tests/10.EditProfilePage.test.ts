...
describe('10 - Crie o formulário de edição de perfil', () => {
  ...
  it('Será validado se é feita a requisição para getUser para recuperar as informações da pessoa logada', async () => {
  ...
  it('Será validado se o formulário é renderizado já preenchido com as informações da pessoa logada', async () => {
    renderPath('/profile/edit');
    ...
    expect(screen.getByTestId('edit-input-email')).toHaveValue(
      'email@test.com',
    );
    expect(screen.getByTestId('edit-input-description')).toHaveValue(
      'Lorem ipsum',
    );
  ...
  it('Será validado se é possível alterar os valores dos campos', async () => {
    renderPath('/profile/edit');
  ...
  it('Será validado se o botão salvar é habilitado somente se todos os campos estiverem válidos', async () => {
  ...
  it('Será validado se as informações são enviadas usando a API updateUser', async () => {
  ...
  it('Será validado se após salvar as informações a pessoa é redirecionada para a página de exibição de perfil', async () => {
    renderPath('/profile/edit');
